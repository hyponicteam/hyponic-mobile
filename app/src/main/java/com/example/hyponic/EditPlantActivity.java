...
import com.example.hyponic.databinding.ActivityEditPlantBinding;
...
public class EditPlantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSave.setOnClickListener(view -> {
            editData();
//            Intent moveIntent = new Intent(EditPlantActivity.this, DetailPlantActivity.class);
//            startActivity(moveIntent);
    ...
    public void getData() {
        AndroidNetworking.get(BASE_URL+"growths/"+pref.getSpGrowthId())
    ...
    public void editData() {
        AndroidNetworking.patch(BASE_URL+"growths/"+pref.getSpGrowthId())
                .addHeaders("Authorization","Bearer "+pref.getSPToken())
                .addHeaders("Accept", "application/json")
