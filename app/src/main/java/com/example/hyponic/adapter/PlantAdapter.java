...
public class PlantAdapter extends RecyclerView.Adapter<PlantAdapter.ListViewHolder> {
    private final ArrayList<Plant> listPlant;
    private final FragmentManager fragmentManager;
    private final Context plantContext;
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
        ...
        holder.tvView.setOnClickListener(view -> {
            ...
            mFragmentManager
                    .beginTransaction()
                    .replace(R.id.plants, mCategoryFragment, Detailplantfragment.class.getSimpleName())
                    .addToBackStack(null)
                    .commit();
        });
        holder.tvEdit.setOnClickListener(view -> {
            pref.saveSPString(SharedPrefManager.SP_PLANT_ID,plant.getId());
            EditPlantFragment editPlantFragmentFragment = new EditPlantFragment();
            editPlantFragmentFragment.show(fragmentManager, EditPlantFragment.class.getSimpleName());
        });
